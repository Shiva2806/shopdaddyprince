      ...
      >
              ...
              {NAV_LINKS.map((link) => {
                ...
                return (
                  <div key={link.href} className="relative group flex items-center">
                    <Link
                      href={link.href}
                      className="px-3 py-2 font-body text-[11px] tracking-widest uppercase transition-colors"
            ...
            <div className="flex items-center gap-3">
              ...
              {session ? (
                <div className="relative group hidden lg:block">
                  ...
                  <div
                    className="absolute right-0 top-8 w-44 shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 border"
                    style={{ backgroundColor: "var(--bg-card)", borderColor: "var(--border)" }}
                  >
                    {[
              ...
              <button className="lg:hidden transition-colors" style={{ color: "var(--text-muted)" }} onClick={() => setMenuOpen(!menuOpen)}>
        ...
        {menuOpen && (
          <div className="lg:hidden border-t max-h-[80vh] overflow-y-auto" style={{ backgroundColor: "var(--bg-card)", borderColor: "var(--border)" }}>
            ...
            {/* Mobile Menu Socials */}
            <div className="px-5 py-4 border-t flex items-center justify-center gap-6 text-[var(--text-muted)] animate-fade-in" style={{ borderColor: "var(--border)" }}>
              <a
