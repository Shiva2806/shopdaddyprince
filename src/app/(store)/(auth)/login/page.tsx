      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="glass-card p-8">
          ...
          >
            ...
            <Link href="/terms" className="underline hover:text-gold-theme transition-colors">
              Terms of Service
            </Link>{" "}
            and{" "}
            <Link href="/privacy" className="underline hover:text-gold-theme transition-colors">
              Privacy Policy
            </Link>
          </p>
        </div>
