...
export default async function ProductPage({ params }: Props) {
  ...
  const mappedProduct = {
    ...
    images: p.images && p.images.length > 0 ? p.images : ["https://images.unsplash.com/photo-1579783900882-c0d3dad7b119?w=900&q=90"],
  ...
  const related = ((dbRelated as any) || []).map((prod: any) => ({
    ...
    images: prod.images && prod.images.length > 0 ? prod.images : ["https://images.unsplash.com/photo-1579783900882-c0d3dad7b119?w=900&q=90"],
